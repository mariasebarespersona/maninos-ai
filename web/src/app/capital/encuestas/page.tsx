...
export default function EncuestasPage() {
  return (
    <div className="space-y-6 animate-fade-in max-w-5xl">
      <div>
        <h1 className="font-serif text-2xl" style={{ color: 'var(--ink)' }}>Encuestas</h1>
        <p className="text-sm mt-1" style={{ color: 'var(--slate)' }}>
          <ClipboardList className="w-4 h-4 inline mr-1" style={{ color: 'var(--gold-700)' }} />
          Resultados de las encuestas de satisfacción enviadas a los clientes.
        </p>
      </div>
