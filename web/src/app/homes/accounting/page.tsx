                ...
                {transactions.map(t => {
                  ...
                  return (
                    <tr key={t.id} className="border-b hover:bg-sand/20 transition-colors" style={{ borderColor: 'var(--sand)' }}>
                      ...
                      <td className="px-4 py-3 max-w-[250px]"><p className="truncate text-sm" style={{ color: 'var(--charcoal)' }}>{t.properties?.property_code ? `ID ${t.properties.property_code}` : t.description}</p><p className="text-xs" style={{ color: 'var(--ash)' }}>{t.transaction_number}</p></td>
